...
insert into THUOC (MATHUOC, MALOAITHUOC, MAHSX, MAXUATXU, TENTHUOC, HINHTHUOC, THANHPHAN, CONGDUNG, BAOQUAN, GHICHUTHUOC, DVT, SOLOTHUOC, NGAYSANXUAT, HANSUDUNG, DONGIATHUOC, SOLUONGTON)
values ('TH05','L002','HSX03','XX02',N'Diclofenac',N'diclofenac.png',N'Diclofenac 50mg, sắt III oxid, PVP vd 1 viên',N'Sử dụng để giảm đau, sưng tấy hoặc viêm do các thương tích và các triệu chứng như viêm khớp, viêm thấp khớp, kinh nguyệt',N'bảo quản ở nhiệt độ phòng, tránh ẩm và tránh ánh sáng. Không bảo quản trong phòng tắm hoặc trong ngăn đá',N'Quá mẫn đã biết với hoạt chất hay tá dược của thuốc. Loét dạ dày tá tràng',N'Hộp',14,'12-12-2017','12-12-2019',200000,25)
...
--
insert into THUOC (MATHUOC, MALOAITHUOC, MAHSX, MAXUATXU, TENTHUOC, HINHTHUOC, THANHPHAN, CONGDUNG, BAOQUAN, GHICHUTHUOC, DVT, SOLOTHUOC, NGAYSANXUAT, HANSUDUNG, DONGIATHUOC, SOLUONGTON)
values ('TH08','L004','HSX02','XX03',N'Acetylcystein',N'acetylcystein.png',N'Acetylcystein 100mg, tá dược vừa đủ',N'Acetylcystein là thuốc thuộc nhóm thuốc long đờm, có tác dụng làm loãng chất nhầy để chúng dễ dàng lưu thông qua phổi',N'Được bảo quản ở nhiệt độ phòng, tránh ẩm, tránh ánh sáng',N'Acetylcysteine chống chỉ định cho bệnh nhân hen suyễn hoặc có tiền sử hen',N'Vỉ',25,'08-05-2018','08-05-2020',220000,25)
...
insert into THUOC (MATHUOC, MALOAITHUOC, MAHSX, MAXUATXU, TENTHUOC, HINHTHUOC, THANHPHAN, CONGDUNG, BAOQUAN, GHICHUTHUOC, DVT, SOLOTHUOC, NGAYSANXUAT, HANSUDUNG, DONGIATHUOC, SOLUONGTON)
values ('TH10','L004','HSX01','XX03',N'Mesna',N'mesna.jpg',N'Mesna 200mg, tá dược vừa đủ',N'Mesna có tác dụng ngăn ngừa hoặc giảm thiểu những tác dụng độc hại của hóa trị đối với bàng quang',N'Bảo quản ở nơi khô ráo, tránh ánh sáng, không được để trong ngăn đá hay phòng tắm',N'Quá mẫn với mesna hoặc các phức hợp khác có thiol',N'Hộp',26,'01-10-2019','01-10-2021',180000,35)
...
values ('HDB001','KH02','NV03','08-10-2020',10,35000)

insert into HOADONBAN (MAHDB, MAKH, MANV, NGAYLAPBAN, VAT, TONGTIENBAN)
values ('HDB002','KH01','NV08','09-05-2019',0,77000)

insert into HOADONBAN (MAHDB, MAKH, MANV, NGAYLAPBAN, VAT, TONGTIENBAN)
values ('HDB003','KH04','NV05','13-07-2018',0,52000)

insert into HOADONBAN (MAHDB, MAKH, MANV, NGAYLAPBAN, VAT, TONGTIENBAN)
values ('HDB004','KH03','NV02','26-04-2019',10,68000)
...
values ('PNT001','HSX01CY','20-10-2020','',1,0)

insert into PHIEUNHAPTHUOC(MAPNT, MANCC, NGAYNHAPTHUOC, GHICHUNT, TRANGTHAI, TONGTIEN)
values ('PNT002','HSX01CY','18-5-2021','',0,0)

insert into PHIEUNHAPTHUOC(MAPNT, MANCC, NGAYNHAPTHUOC, GHICHUNT, TRANGTHAI, TONGTIEN)
values ('PNT003','DIFOCO','15-3-2021','',1,0)
